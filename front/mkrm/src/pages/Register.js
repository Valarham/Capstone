        ...
        {mdUp && (
          <SectionStyle>
            <Typography lang="ko" variant="h3" sx={{ px: 5, mt: 10, mb: 5 }}>
              우리와 함께 더 효과적으로 작업을 관리하십시오.{/* Manage the job more effectively with us */}
            </Typography>
        ...
        <Container>
          <ContentStyle>
            ...
            <Typography lang="ko" sx={{ color: 'text.secondary', mb: 5 }}>
              영원히 무료입니다. 신용 카드가 필요하지 않습니다.{/* Free forever. No credit card needed. */}
            </Typography>
            ...
            <Typography lang="ko" variant="body2" align="center" sx={{ color: 'text.secondary', mt: 3 }}>
              ...
              에 동의합니다.&nbsp;{/* By registering, I agree to HUFS_CAPSTONE */}
            </Typography>
